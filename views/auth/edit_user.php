          ...
          <div class="box box-info">
            <?php echo form_open(uri_string());?>
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php echo form_input(array('class' => 'form-control', 'placeholder' => lang('create_user_identity_label'), 'readonly' => null));?>
                  </div>
                  <div class="col-md-6">
                    <?php echo lang('create_user_company_label', 'company');?> <br />
                    <?php echo form_input(array_merge($company, array('class' => 'form-control', 'placeholder' => lang('create_user_company_label'))));?>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php echo form_input(array('class' => 'form-control', 'placeholder' => lang('create_user_email_label'), 'readonly' => null));?>
                  </div>
                  <div class="col-md-6">
                    <?php echo lang('create_user_phone_label', 'phone');?> <br />
                    <?php echo form_input(array_merge($phone, array('class' => 'form-control', 'placeholder' => lang('create_user_phone_label'))));?>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php echo form_input(array_merge($password, array('class' => 'form-control', 'placeholder' => lang('create_user_password_label'))));?>
                  </div>
                  <div class="col-md-6">
                    <?php echo lang('create_user_password_confirm_label', 'password_confirm');?> <br />
                    <?php echo form_input(array_merge($password_confirm, array('class' => 'form-control', 'placeholder' => lang('create_user_password_confirm_label'))));?>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <?php echo form_submit('submit', lang('edit_user_submit_btn'), 'class="btn btn-sm btn-flat btn-primary"'); ?>
              </div>
            <?php echo form_close();?>
          </div>
          <!-- /.box -->
