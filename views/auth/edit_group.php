        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
										...
										<?php echo form_input(array_merge($group_name, array('class' => 'form-control', 'placeholder' => lang('edit_group_name_label'))));?>
                  </div>
                  <div class="col-md-6">
										<?php echo lang('edit_group_desc_label', 'description');?> <br />
										<?php echo form_input(array_merge($group_description, array('class' => 'form-control', 'placeholder' => lang('edit_group_desc_label'))));?>
                    </div>
                </div>
              ...
              <div class="box-footer">
                <?php echo form_submit('submit', lang('edit_group_submit_btn'), 'class="btn btn-sm btn-flat btn-primary"'); ?>
              </div>
            <?php echo form_close();?>
          </div>
          <!-- /.box -->
