          ...
          <div class="box box-info">
            <?php echo form_open("auth/create_user");?>
                ...
                <div class="row">
                  <?php // if($identity_column !== 'email'): ?>
                    <div class="col-md-6">
                      ...
                      <?php echo form_input(array_merge($identity, array('class' => 'form-control', 'placeholder' => lang('create_user_identity_label'), 'readonly' => null)));?>
                    </div>
                  <?php // endif; ?>
                  <div class="col-md-6">
              ...
              <div class="box-footer">
                <?php echo form_submit('submit', lang('create_user_submit_btn'), 'class="btn btn-sm btn-flat btn-primary"'); ?>
              </div>
            <?php echo form_close();?>
          </div>
          <!-- /.box -->
