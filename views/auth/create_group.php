              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
										...
										<?php echo form_input(array_merge($group_name, array('class' => 'form-control', 'placeholder' => lang('create_group_name_label'))));?>
                  </div>
                  <div class="col-md-6">
										<?php echo lang('create_group_desc_label', 'description');?> <br />
										<?php echo form_input(array_merge($description, array('class' => 'form-control', 'placeholder' => lang('create_group_desc_label'))));?>
                    </div>
                </div>
              </div>

              <div class="box-footer">
                <?php echo form_submit('submit', lang('create_group_submit_btn'), 'class="btn btn-sm btn-flat btn-primary"'); ?>
              </div>
            <?php echo form_close();?>
          </div>
          <!-- /.box -->
